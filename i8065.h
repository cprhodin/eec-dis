...
#define I8065_INVALID_INSTRUCTION                                                                  \
    INSTRUCTION_DEF( 0x00, "********<invalid instruction>********", flds_intrinsic, TGT_INVALID )

// index: opcode / 16 - 4
#define I8065_PREFIXED_INSTRUCTION_SET                                                             \
...
#define I8065_INSTRUCTION_SET                                                                      \
    ...
    INSTRUCTION_DEF( 0x10, "rombank", flds_intrinsic,0 ),                                          \
    ...
    INSTRUCTION_DEF( 0xf1, "retei", flds_intrinsic,  TGT_EXECUTION_BARRIER ),                      \
    INSTRUCTION_DEF( 0xf2, "pushf", flds_intrinsic,  0 ),                                          \
    INSTRUCTION_DEF( 0xf3, "popf",  flds_intrinsic,  0 ),                                          \
    INSTRUCTION_DEF( 0xf4, "bank0", flds_intrinsic,  0 ),                                          \
    INSTRUCTION_DEF( 0xf5, "bank1", flds_intrinsic,  0 ),                                          \
    INSTRUCTION_DEF( 0xf6, "bank2", flds_intrinsic,  0 ),                                          \
    ...
    INSTRUCTION_DEF( 0xfd, "bank3", flds_intrinsic,  0 ),                                          \
